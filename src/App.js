...
const slides = [
  ...
  {
    name : 'Beauty',
    src : process.env.PUBLIC_URL + '/images/beauty.jpg',
    color : 'white'
  },
  {
    name : 'Enfants',
...
function App() {
  ...
  return (
    <div class="App">
      ...
      <main>
        <Slider slides={slides} onSlideChange={onSlideChange}></Slider>
      </main>
